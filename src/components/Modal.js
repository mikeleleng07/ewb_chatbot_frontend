...
const CustomModal = ({ onSave = () => {}, toggle = () => {}, activeItem = {} }) => {
 ...
 const addressParts = [
  activeItem && activeItem.userData && activeItem.userData.table && activeItem.userData.table.homeStAddress1,
  activeItem && activeItem.userData && activeItem.userData.table && activeItem.userData.table.homeCity,
  activeItem && activeItem.userData && activeItem.userData.table && activeItem.userData.table.homeProvince
];
